...
=============================================================================================
 ...
 Description :  This javascript program, in collaboration with breakout.html, uses the HTML5
                ...
                THIS VERSION INCREASES USER PERCEPTION OF CONTROL AND EFFECTANCE BY USING THE
...
function main()
{
    // welcome message
    if (!notFirstPlay)
        alert("Welcome to Breakout!\n\nUse the mouse to control your paddle. Try to elimate all of the blocks without losing all your lives!");
