...
=============================================================================================
 ...
 Description :  This javascript program, in collaboration with breakout.html, uses the HTML5
                ...
                THIS VERSION DECREASES USER PERCEPTION OF EFFECTANCE BY HAVING THE CONTROLS
                RESPOND ONLY 75% OF THE TIME
...
function main()
{
    // welcome message
    if (!notFirstPlay)
        alert("Welcome to Breakout!\n\nPress the left and right arrow keys to move your paddle. Try to elimate all of the blocks without losing all your lives!");
...
function keyDownHandler(e)
{
    if(e.keyCode == 39) 
    {
        if(Math.random() < 0.75) rightPressed = true; // won't work 25% of the time
    }
    
    else if(e.keyCode == 37) 
    {
        if(Math.random() < 0.75) leftPressed = true; // won't work 25% of the time
    }
}
